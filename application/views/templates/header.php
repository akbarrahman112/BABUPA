                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <li class="nav-item dropdown">                           
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <li><a class='nav-item nav-link' href="<?php echo base_url('login')?>">Masuk</a></li>
                                        <li><a class='nav-item nav-link' href="<?php echo site_url('register')?>">Daftar</a></li>
                                    </ul> 
                                    <?php else: ?>
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            <a href="<?php echo base_url('pengguna/riwayatTransaksi');?>" class="nav-item nav-link">Riwayat Transaksi</a> 
