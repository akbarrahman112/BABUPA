...
<head>
    ...
    <title>BABUPA| Halaman List Destinasi Wisata</title>
                            ...
                            <div class="card card-plain table-plain-bg">
                                ...
                                <div class="card-body table-full-width table-responsive">
                                    ...
                                    <div class="card-title" style="margin-left:15px; text-align: left;">
                                        <a href="<?=site_url('admin/tambah')?>"><button type="button" class="btn btn-success btn-fill btn-md"><span class="fas fa-user-plus">Tambah Wisata</span></button></a>
                                    </div>
                                    <br>
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $datas['deskripsi_lainnya']; ?></td>  
                                                <td><?= $datas['harga_tiket']; ?></td>  
                                                <td><?= $datas['gambar']; ?></td>     
                                                <td>
                                                    <a href="<?= base_url('admin/edit/'.$datas['id_wisata']); ?>" class="btn btn-warning">Edit</a>                                                                        
                                                    <a href="<?= base_url('admin/delete/'.$datas['id_wisata']); ?>" class="btn btn-danger">Hapus</a>
                                                </td>
                                            </tr>
                                            <?php } ?>   
                                        </tbody>
