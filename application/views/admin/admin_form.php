...
<head>
    ...
    <title>BABUPA| Tambah List Wisata</title>
            ...
            <?php echo form_open_multipart('admin/tambah'); ?> 
                <form action="" method="POST">                        
                    <div class="form-group">
                        ...
                        <input autocomplete="off" type="text" class="form-control" name ="nama_wisata" aria-describedby="basic-addon2">                         
                    </div>       
                    <div class="form-group">
                        <label for="">Nama Pengelola</label><br>
                        <select name="id_pengelola" class="form-control">
                            <?php foreach($pengelola as $pengelolas) : ?>                     
                            <option value="<?= $pengelolas['id_user']; ?>"><?= $pengelolas['fullname']; ?></option>   
                            <?php endforeach ?> 
                        </select>                        
                    </div>                                                                                                                    
                    <div class="form-group">
                        <label for="">Deskripsi</label>
                        <textarea type="text" class="form-control" name ="deskripsi" aria-describedby="basic-addon2"></textarea>                    
                    </div>  
                    <div class="form-group">
                        <label for="">Fasilitas</label>
                        <textarea type="text" class="form-control" name ="fasilitas" aria-describedby="basic-addon2"></textarea>                    
                    </div>                                    
                    <div class="form-group">
                        <label for="">Deskripsi Lainya</label>
                        <textarea type="text" class="form-control" name ="deskripsi_lainnya" aria-describedby="basic-addon2"></textarea>                  
                    </div>
                    <div class="form-group">
                        <label for="">Harga Tiket</label>
                        <input type="number" min=0 class="form-control" name ="harga_tiket" aria-describedby="basic-addon2">             
                    </div>     
                    <div class="form-group">
