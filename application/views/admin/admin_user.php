...
<head>
    ...
    <title>BABUPA| Halaman List User</title>
        ...
        <div class="main-panel">
            <nav class="navbar navbar-expand-lg " color-on-scroll="500">
                <div class="container-fluid">
                    <a class="navbar-brand" href="#"> List Akun User </a>
                        ...
                        <div class="col-md-12">
                            <div class="card card-plain table-plain-bg">
                                <div class="card-header ">
                                    <h4 class="card-title">Tabel List User Akun</h4>
                                </div>
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?=$file->usertype?></td>
                                                <td>
                                                    <a href="<?=site_url('admin/deletePengguna/'.$file->id_user)?>" onclick="return confirm('Yakin untuk menghapus data ini?')" class="btn btn-danger btn-fill btn-sm"><span class="fas fa-trash-alt"></span></a>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
