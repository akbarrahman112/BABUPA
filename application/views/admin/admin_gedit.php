...
<head>
    ...
    <title>BABUPA| Edit List Galeri</title>
        ...
        <div class="main-panel">
            <nav class="navbar navbar-expand-lg " color-on-scroll="500">
                <div class="container-fluid">
                    <a class="navbar-brand" href="#">Form Edit Galeri</a>
...
<section class="contact">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">     
            <?php echo form_open_multipart('admin/gedit/'.$data['id_galeri']); ?>                                                                                                                                       
                    <div class="form-group">
                        <label for="">Deskripsi</label>
                        <input autocomplete="off" type="type" class="form-control" name ="deskripsi" value="<?= $data['deskripsi']; ?>" aria-describedby="basic-addon2">                        
                    </div>       
                    <div class="form-group">
                        <label for="">Gambar</label>
                        <input type="file" name="gambar" class="form-control" aria-describedby="basic-addon2">
                        <input type="text" name="gambar_old" value="<?= $data['gambar']; ?>" hidden>                       
                    </div>                           
                    <div class="form-group">
