                        ...
                        <div class="col-md-12">
                            <div class="card card-plain table-plain-bg">
                                <div class="card-header ">
                                    <h4 class="card-title">Tabel List User Akun Pengelola</h4>
                                </div>
                                <div class="card-body table-full-width table-responsive">
                                    ...
                                    <a href="<?=site_url('admin/tambahPengelola')?>" class="btn btn-success btn-fill btn-md"><span class="fas fa-user-plus">Tambah Pengelola</a>
                                    <br>
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?=$file->usertype?></td>
                                                <td>
                                                    <a href="<?=site_url('admin/deletePengelola/'.$file->id_user)?>" onclick="return confirm('Yakin untuk menghapus data ini?')" class="btn btn-danger btn-fill btn-sm"><span class="fas fa-trash-alt"></span></a>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
