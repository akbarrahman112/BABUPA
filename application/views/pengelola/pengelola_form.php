                            ...
                            <div class="card">
                                <div class="card-body">
                                    <?php
                                        ...
                                        if(isset($pengelola)) {
                                            $nama_wisata=$pengelola->nama_wisata;
                                            $deskripsi=$pengelola->deskripsi;
                                            $gambar=$pengelola->gambar;                                        
                                        }
                                    ?>
                                        ...
                                        <div class="row pull-right">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <a href="<?=site_url('pengelola/wisata')?>"><button type="button" class="btn btn-danger btn-fill">Kembali</button></a>
                                                </div>
                                            </div>
                                        </div>
